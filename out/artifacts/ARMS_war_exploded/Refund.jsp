...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-xl bg-secondary rounded-top">
            <h5 class="navbar-text text-white font-weight-bold">机票退改</h5>
        </nav>
        <br>
        <h4 class="text-muted font-weight-bold">可退改</h4>
        <hr>
        <div class="bg-light">
            <table class="table">
                <thead>
                ...
                <tbody>
                <c:forEach items="${ablelist}" var="order">
                    <tr>
                        <td>${order.id}</td>
                        <td>${order.name}</td>
                        ...
                        <td>${order.status}</td>
                        <td>
                            <a class="btn btn-secondary" href="/SkipServlet?skip=ref&id=${order.id}">退票</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
