...
<div class="container-fluid">
    ...
    <div class="container">
        <nav>
            <ul class="nav nav-pills nav-fill ">
                ...
                <button class="btn bg-white" disabled><span class="fa fa-long-arrow-right"></span></button>
                <li class="nav-item bg-danger text-white rounded"><a class="nav-link disabled">完成支付</a></li>
            </ul>
        </nav>
    </div>
    <br>
    <!-- 指示栏结束 -->
    <div class="container">
        <div class="finsh-background">
            <div class="text-center">
                <h3 class="text-danger">您已完成支付，接下来您可以：</h3>
            </div>
            <br><br><br>
            <div class="justify-content-center">
                <div class="align-self-center">
                    <a class="btn btn-danger" href="/SkipServlet?skip=choiceseat">开始选座</a>
